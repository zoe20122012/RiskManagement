...
module.exports = cds.service.impl(async function() {
    ...
    //Define constants for the Risk and Business Partners entities from the risk-service.cds file
    ...
    const BPsrv = await cds.connect.to("OP_API_BUSINESS_PARTNER_SRV");
    /**
    ...
    this.on("READ", Risks, async (req, next) => {
        ...
        /**
         * Instead of carrying out the expand, issues a separate request for each business partner
         * This code could be optimized, instead of having n requests for n business partners, just one bulk
